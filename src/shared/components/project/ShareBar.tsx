...
const SITE_URL =
  typeof window !== 'undefined'
    ...
    : process.env.NEXT_PUBLIC_SITE_URL || 'https://themovearchids.vercel.app';
...
export function ShareBar({ slug, title }: ShareBarProps) {
  ...
  const itemClass =
    'flex items-center gap-1.5 text-[10px] uppercase tracking-[0.28em] text-[var(--mode-text-primary)]/50 hover:text-[var(--mode-text-primary)] transition-colors duration-200';
