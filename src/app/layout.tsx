...
export const metadata: Metadata = {
  title: 'The Move',
  description:
    'Discover The Move — a luxury & minimalist interior design studio in Myanmar specializing in aesthetic, minimalist, and functional spaces for homes and businesses.',
  alternates: {
